<template>
	<view>
		...
		<view class="colonn">
			...
			style="margin-left: 0rpx;margin-top: 40rpx;"
			...
			<view class="roww w-750  m-top-40 m-bottom-25 center_center">
				...
				<view class="xiayibux" style="width: 600rpx;"
				:style="{
